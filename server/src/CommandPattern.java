...
public final class CommandPattern {
    ...
    public static final Pattern UFILE = Pattern.compile("^UFile (.*)$");
    ...
    public static final Pattern GFILE = Pattern.compile("^GFile (.*)$");
    ...
    public static final Pattern UPUT = Pattern.compile("^UPut \\[(.*)] \\[(.*)] (\\d*)$");
    public static final Pattern GPUT = Pattern.compile("^GPut \\[(.*)] \\[(.*)] (\\d*)$");
